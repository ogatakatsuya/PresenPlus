...
<div class="flex mb-6 items-center w-80 mx-auto">
	<input 
		type="text" 
		placeholder="Search rooms..." 
		bind:value={searchQuery} 
		class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-6 p-2.5"
	/>
	<button 
	on:click={filterRooms} 
	class="p-2.5 ms-2 text-sm font-medium text-white bg-blue-600 rounded-lg border border-blue-700 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300"
	>
