...
{#if makeit=="close"}
<button type="button" on:click={opencloseRoom} class="text-gray-600 font-noto bg-gray hover:bg-gray-100 border border-gray-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base leading-6 px-5 py-2.5 text-center inline-flex items-center">
	Close
...
{:else if makeit="open"}
<button type="button" on:click={opencloseRoom} class="text-white font-noto bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base leading-6 px-5 py-2.5 text-center inline-flex items-center">
	Open
